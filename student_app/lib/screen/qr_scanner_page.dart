...
class _QRScannerPageState extends State<QRScannerPage> {
  ...
  Future<void> _loadVehicleAndScheduleData() async {
    ...
    setState(() {
      vehicleId = prefs.getString(
        'vehicleId',
      ); // Retrieve vehicleId from SharedPreferences
      scheduleId = prefs.getString(
        'scheduleId',
      ); // Retrieve scheduleId from SharedPreferences
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          MobileScanner(onDetect: _onDetect, controller: _scannerController),
          Align(
